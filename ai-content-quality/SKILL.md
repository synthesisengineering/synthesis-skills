...
3. **Verify and enhance sourcing** -- Check all citations are real and relevant, add specific attribution, include original research or first-hand sources. Use the fact-checking skill for thorough verification.
