---
name: synthesis-social-media-post
description: "Write social media posts about events, experiences, or topics for LinkedIn, Twitter/X, and Instagram. Use when asked to: social media post, write tweet, LinkedIn post, Instagram post, write social content, post about event."
license: "CC0-1.0"
metadata:
  author: "Rajiv Pant"
  version: "1.0.0"
...
Write social media posts about events, experiences, topics, or other content for multiple platforms. This is a general-purpose social media writing skill (for blog-specific promotion, see the synthesis-blog-promotion skill).
...
1. Clarify the purpose and desired outcomes, then improve on them.
2. Recap the instructions provided.
3. Present a plan for the posts.
4. Write the posts.
